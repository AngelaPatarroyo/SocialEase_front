...
const scenarios: ScenarioCardProps[] = [
  ...
  },
  {
    ...
    level: 'Beginner',
    xp: 25,
    imageUrl: '/images/scenarios/say-no.jpg',
  },
  {
    title: 'Start Small Talk',
    level: 'Beginner',
    xp: 25,
    imageUrl: '/images/scenarios/smalltalk.jpg',
  },
  {
  ...
  },
  {
    ...
    level: 'Intermediate',
    xp: 30,
    imageUrl: '/images/scenarios/coworker.jpg',
  },
  {
    title: 'Give a Compliment',
    level: 'Intermediate',
    xp: 30,
    imageUrl: '/images/scenarios/compliment.jpg',
  },
  {
    title: 'Ask for Help in Public',
    level: 'Intermediate',
    xp: 30,
    imageUrl: '/images/scenarios/ask-help.jpg',
    isVR: true,
  },
  {
    ...
    level: 'Intermediate',
    xp: 30,
    imageUrl: '/images/scenarios/speak-up.jpg',
  },
  {
    title: 'Make a Phone Call',
    level: 'Advanced',
    xp: 35,
    imageUrl: '/images/scenarios/phone.jpg',
  },
  {
    title: 'Handle Criticism',
    level: 'Advanced',
    xp: 35,
    imageUrl: '/images/scenarios/criticism.jpg',
  },
  {
    title: 'Disagree Respectfully',
    level: 'Advanced',
    xp: 40,
    imageUrl: '/images/scenarios/disagree.jpg',
  },
  {
    title: 'Mock Interview',
    level: 'Advanced',
    xp: 45,
    imageUrl: '/images/scenarios/interview.jpg',
    isVR: true,
  },
  {
